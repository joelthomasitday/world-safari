      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
          {REASONS.map((reason, idx) => (
            <ScrollReveal key={idx} animation="reveal" delay={100 + idx * 150}>
              <div className="flex flex-col items-center text-center group">
                <div className="w-16 h-16 rounded-full bg-primary/5 flex items-center justify-center mb-8 group-hover:bg-primary/10 group-hover:scale-110 transition-all duration-500 ease-out">
